...
Read [HSM configuration](../hsm/configuration.md), [ACME](../protocols/acme.md) and
[Observability](../operations/observability.md) alongside this guide.
...
`config.yaml` (see [RBAC & audit](../security/rbac-and-audit.md)):
...
The chart can expose the [gRPC API](../protocols/grpc-api.md) — the core issuance/revocation/
...
[Supply-chain security](../development/supply-chain.md).
