...
See [HSM / PKCS#11 configuration](configuration.md) for every setting.
...
CRLs). See the [CA guide](../ca/overview.md) for the full lifecycle.
...
RSA-OAEP-SHA256. See [password encryption](../secrets/password-encryption.md).
...
- Set `policy.allow_root_basic_auth: false` once OIDC admins exist, to remove the
  shared-credential superuser. See [RBAC & audit](../security/rbac-and-audit.md).
- Confirm the [tamper-evident event log](../security/rbac-and-audit.md#2-tamper-evident-audit-logging)
...
- [HSM / PKCS#11 configuration](configuration.md)
- [Certificate authority operations](../ca/overview.md)
- [Password / secret encryption](../secrets/password-encryption.md)
