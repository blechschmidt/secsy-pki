...
[key-ceremony notes in artifact-signing.md](../signing/artifact-signing.md#key-ceremony-notes-for-signing-keys)
...
- **YubiHSM 2:** use `yubihsm-shell` `backup`/`restore` under a wrap key, or
  ...
  [Production HSM migration](production-migration.md).
