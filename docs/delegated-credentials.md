...
> whose key it generated server-side: a [PKCS#12 export](pkcs12.md) whose subject
> key was **escrowed** under the M-of-N recovery policy
> ([key escrow](password-encryption.md)). The `POST /api/ca/{id}/delegated-credential`
...
- **OCSP Must-Staple is forbidden.** RFC 9345 §4.2 forbids combining the
  ...
  [OCSP Must-Staple](certificate-authority.md#ocsp-must-staple-rfc-7633) TLS
