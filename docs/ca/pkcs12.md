...
- **S/MIME** ([S/MIME e-mail protection](../certificates/smime.md)): mail clients import a
...
- **Device / MDM enrollment** ([SCEP & EST](../protocols/scep-est.md)): an MDM or
...
[FIPS mode](../security/fips.md) the legacy encoders (3DES/RC2 + SHA-1) are refused and only
`modern` is permitted.
...
The **PKCS#12** page in the [operator console](../operations/web-console.md) drives the same
...
[M-of-N recovery policy](../secrets/password-encryption.md#key-escrow-and-recovery-m-of-n-dual-control):
...
- [Certificate authority](overview.md) — issuance, profiles, CRL/OCSP
- [S/MIME e-mail protection](../certificates/smime.md) — the primary consumer of `.p12` delivery
- [Password / secret encryption](../secrets/password-encryption.md) — the escrow/recovery layer
