...
[compromised-key blocklist](../issuance/key-checks.md#operator-compromised-key-blocklist)
...
[compromised-key blocklist](../issuance/key-checks.md#operator-compromised-key-blocklist) so
