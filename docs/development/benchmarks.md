...
[**Performance profiling (pprof)**](../operations/runbook.md#performance-profiling-pprof--hsm-latency--session-pool-contention).
The `server:profile` capability is documented in [RBAC & audit](../security/rbac-and-audit.md).
