...
[Audit-chain anchoring runbook section](../operations/runbook.md#audit-chain-anchoring).
...
- **Liveness over completeness.** The feed targets humans watching the console,
  ...
  metric (see [Observability](../operations/observability.md)).
...
- **Systematic authorization coverage.** A table-driven regression matrix
  ...
  [authz-regression-matrix.md](../development/authz-regression-matrix.md).
