...
[tamper-evident audit log](../security/rbac-and-audit.md), with the actor set to the ACME
...
- [CAA checking](../issuance/caa.md) — the other fail-closed pre-issuance DNS gate
- [Observability](../operations/observability.md) — scraping the metrics above
- [RBAC & audit](../security/rbac-and-audit.md) — the `acme.mpic` audit event
